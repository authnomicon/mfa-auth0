...
describe('auth0/client/browserish/credential', function() {
  ...
  describe('getCredential', function() {
    ...
    describe('obtaining a token', function() {
      var guardian;
      var mfaClient = {
    ...
    describe('obtaining a token to be used when polling transaction state', function() {
      var guardian;
      var mfaClient = {
        httpClient: { post: function(){} }
      };
    ...
    }); // obtaining a token to be used when polling transaction state
    
    describe('obtaining a ticket', function() {
      var guardian;
      var mfaClient = {
        httpClient: { post: function(){} }
      };
      ...
      it('should not construct MFA API client', function() {
        expect(guardian.callCount).to.equal(0);
      });
      
      it('should not request MFA API to start flow', function() {
        expect(mfaClient.httpClient.post.callCount).to.equal(0);
      });
      
      it('should yield credential', function() {
        expect(credential).to.equal('XXXX0x0Xxxx0xXX0xxXX0xXxxxxxxXXX');
      });
    }); // obtaining a ticket
